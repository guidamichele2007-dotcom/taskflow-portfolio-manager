...
class SubtaskUseCasesTest {
    ...
    @Test
    fun `add subtask appends it with the next order index`() =
        runTest {
    ...
    @Test
    fun `add subtask rejects a blank title`() =
        runTest {
            val repository = repositoryWithTask()
    ...
    @Test
    fun `add subtask to an unknown task fails`() =
        runTest {
    ...
    @Test
    fun `toggle subtask flips its completed flag`() =
        runTest {
            val repository = repositoryWithTask()
    ...
    @Test
    fun `reorder subtasks applies the new order`() =
        runTest {
            val repository = repositoryWithTask()
