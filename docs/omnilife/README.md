...
| — | [Technology Decision Record](technology_decision_record.md) | Le 18 decisioni tecnologiche approvate (linguaggio, backend, database, sync, sicurezza, DevOps…) più le voci TDR-19…40 aggiunte durante gli sprint, ciascuna con almeno 3 alternative confrontate |
